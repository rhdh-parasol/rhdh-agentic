...
**Related ADRs:** [authentication](authentication.md)
...
- **G-2:** CLI backend transport (REST vs MCP Actions) is not decided. Commands need to talk to Backstage — the transport choice affects the `lib/` layer. This is a separate ADR. Blocks: FSD for any pillar command.
